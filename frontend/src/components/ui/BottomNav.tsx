...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Main navigation" className="fixed bottom-0 left-0 right-0 z-40 flex border-t border-border/80 bg-surface/95 backdrop-blur-md shadow-[var(--shadow-elevation-sticky-top)] pb-[env(safe-area-inset-bottom)] gpu-layer">
