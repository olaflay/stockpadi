  ...
  return (
    <svg viewBox={ILLUSTRATION_VIEWBOX} className={className} fill="none" aria-hidden>
      ...
      <path
        ...
        opacity="0.14"
      />
      <path {...STROKE_PROPS} stroke="currentColor" d="M18 42 L24 28 H72 L78 42 Z" />
      ...
      {/* Store entrance door with subtle container fill */}
      <rect x="42" y="52" width="12" height="22" rx="2" fill="currentColor" opacity="0.18" />
