  ...
  return <div className="flex flex-col gap-6">
    ...
    {memberAccountType === "WORKER" && <section>
      ...
      <div className="flex flex-col gap-2 rounded-[var(--radius-card)] border border-border bg-surface-container/40 p-4">
        <p className="text-[length:var(--font-size-body)] text-on-surface">A password is generated by StockPadi and shown to you once — share it with the worker yourself (WhatsApp or in person). It is never sent by email.</p>
        {newPassword && (
