...
const FAQS = [
  ...
  { q: "How do I unlock the app each day?", a: "With your 4-digit PIN. The first sign-in on a new device needs an internet connection; unlocking after that works offline." },
  { q: "Can more than one person use the app?", a: "Yes — add staff under Settings → Staff & Access. Each person gets their own PIN and role-based permissions." },
];
